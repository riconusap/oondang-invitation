...
<template>
  <section class="py-20 px-8 text-center bg-wedding-dark relative z-20">
      <div 
        ref="target"
        :class="[
      ...
      >
          <p class="text-sm text-zinc-400 leading-relaxed font-light whitespace-pre-line">{{ quoteText }}</p>
          <p class="mt-6 font-bold text-sm text-white font-wedding-serif italic">{{ quoteSource }}</p>
      </div>
  </section>
</template>
